...
# ____ all ___________________________________________________________________
...
# # ____ image artifacts  ______________________________________________________
#
...
clean:
	...
	-go get -tool "golang.org/x/vuln/cmd/govulncheck@none"
